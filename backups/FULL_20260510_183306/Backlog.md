Backlog 2026-05-02: 
On the main page. 
Increase the contrast on the pin code input field. It's hard to read the text. 

Increase the contrast on the version number. 

Server hosting and joining: 


Are the feature for multiplayer in place?
- [x] IS there a server list? 
- [x] If a player hosts a game it needs to show up on the server list. 
- [x] If a player clicks join it should get to the server list and they should be able to join a game from the list. 
